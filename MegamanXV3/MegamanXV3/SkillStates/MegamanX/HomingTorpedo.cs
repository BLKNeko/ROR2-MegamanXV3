    ...
    public class HomingTorpedo : BaseSkillState
    {
        ...
        private void FireHT()
        {
            if (!this.hasFired)
            {
                ...
                if (base.isAuthority)
                {
                    ...
                    Util.PlaySound(Sounds.HomingTorpedo, base.gameObject);
                    ProjectileManager.instance.FireProjectile(Modules.Projectiles.greenNProjectile, aimRay.origin, Util.QuaternionSafeLookRotation(aimRay.direction), base.gameObject, this.damageCoefficient * this.damageStat, 0f, Util.CheckRoll(this.critStat, base.characterBody.master), DamageColorIndex.Default, null, -1f);
        ...
        private void FireHTC()
        {
            if (!this.hasFired)
            {
                ...
                Vector3 raygun3 = new Vector3(aimRay.direction.x + 0.5f, aimRay.direction.y, aimRay.direction.z);
                Vector3 raygun4 = new Vector3(aimRay.direction.x - 0.5f, aimRay.direction.y, aimRay.direction.z);
                EffectManager.SimpleMuzzleFlash(EntityStates.Commando.CommandoWeapon.FireRocket.effectPrefab, base.gameObject, this.muzzleString, false);
                EffectManager.SimpleMuzzleFlash(EntityStates.Commando.CommandoWeapon.FireRocket.effectPrefab, base.gameObject, this.muzzleString, false);
                if (base.isAuthority)
                {
                    ...
                    ProjectileManager.instance.FireProjectile(Modules.Projectiles.greenNProjectile, aimRay.origin, Util.QuaternionSafeLookRotation(aimRay.direction), base.gameObject, this.damageCoefficient * this.damageStat, 0f, Util.CheckRoll(this.critStat, base.characterBody.master), DamageColorIndex.Default, null, -1f);
                    ProjectileManager.instance.FireProjectile(Modules.Projectiles.greenNProjectile, aimRay.origin, Util.QuaternionSafeLookRotation(raygun1.normalized), base.gameObject, this.damageCoefficient * 1.25f * this.damageStat, 0f, Util.CheckRoll(this.critStat, base.characterBody.master), DamageColorIndex.Default, null, -1f);
                    ProjectileManager.instance.FireProjectile(Modules.Projectiles.greenNProjectile, aimRay.origin, Util.QuaternionSafeLookRotation(raygun2.normalized), base.gameObject, this.damageCoefficient * 1.25f * this.damageStat, 0f, Util.CheckRoll(this.critStat, base.characterBody.master), DamageColorIndex.Default, null, -1f);
                    ProjectileManager.instance.FireProjectile(Modules.Projectiles.greenNProjectile, aimRay.origin, Util.QuaternionSafeLookRotation(raygun3.normalized), base.gameObject, this.damageCoefficient * 1.25f * this.damageStat, 0f, Util.CheckRoll(this.critStat, base.characterBody.master), DamageColorIndex.Default, null, -1f);
                    ProjectileManager.instance.FireProjectile(Modules.Projectiles.greenNProjectile, aimRay.origin, Util.QuaternionSafeLookRotation(raygun4.normalized), base.gameObject, this.damageCoefficient * 1.25f * this.damageStat, 0f, Util.CheckRoll(this.critStat, base.characterBody.master), DamageColorIndex.Default, null, -1f);
