...
{
    public class XShadowSlashCombo2 : BaseSkillState
    {
        ...
        public override void OnEnter()
        {
            ...
            this.earlyExitDuration = XShadowSlashCombo2.baseEarlyExit / this.attackSpeedStat;
            this.hasFired = false;
            ...
            base.PlayAnimation("Gesture, Override", "XSSlash2", "attackSpeed", this.duration);
            ...
            float dmg = XShadowSlashCombo2.damageCoefficient;
            ...
            this.attack.hitEffectPrefab = XShadowSlashCombo2.hitEffectPrefab;
        ...
        public void FireAttack()
        {
            if (!this.hasFired)
            {
                ...
                if (base.isAuthority)
                {
                    base.AddRecoil(-1f * XShadowSlashCombo2.attackRecoil, -2f * XShadowSlashCombo2.attackRecoil, -0.5f * XShadowSlashCombo2.attackRecoil, 0.5f * XShadowSlashCombo2.attackRecoil);
                    ...
                    if (this.attack.Fire())
                    {
                        ...
                        if (!this.hasHopped)
                        {
                            ...
                            {
                                base.SmallHop(base.characterMotor, XShadowSlashCombo2.hitHopVelocity);
                            }
        ...
        public override void FixedUpdate()
        {
            ...
            if (base.fixedAge >= this.duration && base.isAuthority)
            {
                ...
                {
                    XShadowSlashCombo XSC1 = new XShadowSlashCombo();
                    this.outer.SetNextState(XSC1);
                }
                else
                {
