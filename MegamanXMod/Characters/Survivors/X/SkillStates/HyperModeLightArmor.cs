...
namespace MegamanXMod.Survivors.X.SkillStates
{
    public class HyperModeLightArmor : BaseSkillState
    {
        ...
        public override void OnExit()
        {
            ...
            if (NetworkServer.active)
            {
                characterBody.AddBuff(XBuffs.LightArmorBuff);
            }
        ...
        private void SetSkills()
        {
            ...
            characterBody.skillLocator.primary.SetSkillOverride(characterBody.skillLocator.primary, XSurvivor.XLightBusterSkillDef, GenericSkill.SkillOverridePriority.Contextual);
