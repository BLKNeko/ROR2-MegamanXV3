...
{
    public class XUltimateBuster : BaseChargePrimary
    {

        public override void OnEnter()
        {
            base.OnEnter();
            damageCoefficient = XStaticValues.XUltimateBusterDamageCoefficient;
            procCoefficient = 1f;
            baseDuration = 1f;
        ...
        protected override void FireChargedBullet()
        {
            if (!this.hasFired)
            {
                ...
                if (base.isAuthority)
                {
                    ...
                    XLightBusterChargeProjectille.damageColorIndex = DamageColorIndex.Luminous;
