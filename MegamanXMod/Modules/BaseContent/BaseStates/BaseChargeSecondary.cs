...
{
    public abstract class BaseChargeSecondary : BaseSkillState
    {
        ...
        public override void FixedUpdate()
        {
            ...
            if ((base.fixedAge >= this.fireTime || !base.inputBank || !base.inputBank.skill2.down) && chargeLevel == 3 && hasTime == true)
            {
                FireChargedBullet();
            }
            else if ((base.fixedAge >= this.fireTime || !base.inputBank || !base.inputBank.skill2.down) && chargeLevel == 2 && hasTime == true)
            {
                FireMediumBullet();
            }
            else if ((base.fixedAge >= this.fireTime || !base.inputBank || !base.inputBank.skill2.down) && chargeLevel == 1 && hasTime == true)
            {
                FireSimpleBullet();
            }
