...
namespace MegamanXV3.Modules.Survivors
{
    internal class MyCharacter : SurvivorBase
    {
        ...
        public const string HENRY_PREFIX = MegamanXV3Plugin.DEVELOPER_PREFIX + "_HENRY_BODY_";
        ...
        public override BodyInfo bodyInfo { get; set; } = new BodyInfo
        {
            ...
            bodyNameToken = MegamanXV3Plugin.DEVELOPER_PREFIX + "_HENRY_BODY_NAME",
            subtitleNameToken = MegamanXV3Plugin.DEVELOPER_PREFIX + "_HENRY_BODY_SUBTITLE",
        ...
        public override void InitializeSkills()
        {
            ...
            string prefix = MegamanXV3Plugin.DEVELOPER_PREFIX;
            ...
            */
            ...
            {
                skillName = prefix + "GREENNEEDLE_NAME",
                skillNameToken = prefix + "GREENNEEDLE_NAME",
                skillDescriptionToken = prefix + "GREENNEEDLE_DESCRIPTION",
                skillIcon = Modules.Assets.GreenSpinnerIcon,
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.greenSpinner)),
                activationStateMachineName = "Weapon",
                baseMaxStock = 5,
        ...
        public override void InitializeSkins()
        {
            ...
            #region DefaultSkin
            SkinDef defaultSkin = Modules.Skins.CreateSkinDef(MegamanXV3Plugin.DEVELOPER_PREFIX + "_HENRY_BODY_DEFAULT_SKIN_NAME",
