Shader "Effects/WeaponFX/DistortPerlinMobileEx" {
	Properties {
		...
		_RimColorA ("Rim ColorA", Vector) = (1,1,1,0.5)
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.yz = tmp0.yz * _BumpAmt.xx;
                tmp0.yz = tmp0.yz * _GrabTexture_TexelSize.xy;
                ...
                tmp0.yzw = _RimColorA.xyz * _LightColor0.xyz;
                tmp0.yzw = tmp0.yzw * _LightColor0.www;
                ...
                tmp0.yzw = -tmp1.xyz * _TintColor.xyz + tmp0.yzw;
